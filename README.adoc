...
** <<create_the_docker_image_for_visitor_microservice, Create the Docker image for Visitor Microservice>>
* <<install_leader_chart_for_landmark_microservice, Install leader chart for Landmark microservice >>
** <<create_the_docker_image_for_landmark_microservice,Create the Docker image for Landmark Microservice>>
** <<leader_helm_chart_installation, Leader Helm chart installation>>
* <<install_helm_chart_for_visitor_microservice, Install Helm chart for Visitor microservice>>
